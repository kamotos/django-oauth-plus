...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consumer.logo'
        db.add_column('oauth_provider_consumer', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Consumer.company_name'
        db.add_column('oauth_provider_consumer', 'company_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Consumer.url'
        db.add_column('oauth_provider_consumer', 'url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consumer.logo'
        db.delete_column('oauth_provider_consumer', 'logo')

        # Deleting field 'Consumer.company_name'
        db.delete_column('oauth_provider_consumer', 'company_name')

        # Deleting field 'Consumer.url'
        db.delete_column('oauth_provider_consumer', 'url')
    ...
    models = {
        ...
        'oauth_provider.token': {
            ...
            'timestamp': ('django.db.models.fields.IntegerField', [], {'default': '1349187755L'}),
